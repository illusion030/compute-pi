...
EXECUTABLE = \
	...
	time_test_leibniz_avx benchmark_clock_gettime
...
default: $(GIT_HOOKS) computepi.o
	...
	$(CC) $(CFLAGS) computepi.o time_test.c -DLEIBNIZAVX -o time_test_leibniz_avx -lm
...
gencsv: default
	for i in `seq 100 5000 50000`; do \
		printf "%d " $$i;\
...
clean:
	rm -f $(EXECUTABLE) *.o *.s result_clock_gettime.csv runtime.png error_rate.png
